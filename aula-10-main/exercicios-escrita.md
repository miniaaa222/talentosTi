...
Lembre-se de imprimir no console os resultados.
...
**Dica:** para remover um item de um **array**, você pode utilizar a função _splice_! Caso não se lembre como ela funciona, não tem nenhum problema, uma breve pesquisa no Google te trará vários exemplos.
