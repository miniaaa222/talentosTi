...
let comidaFavorita = ['massa', 'feijão', 'batata', 'chocolate', 'pizza']
let qualSuacomidaFavorita = prompt("usuario ana. qual sua comida favorita?")



console.log ( " Essas São as minhas",comidaFavorita,)
console.log(comidaFavorita[1]=qualSuacomidaFavorita)
